        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <form class="parsley-style-1" autocomplete="off" name="selectForm2"
                        action="{{route('roles.update',$role->id)}}" enctype="multipart/form-data"   method="post">
                             @method('put')
                            {{csrf_field()}}
                                ...
                                <ul id="treeview1">
                                        ...
                                        @foreach($permission as $value)
                                            ...
                                            <label
                                                ...
                                                <td><input id="cat-box" type="checkbox" name="permission[]" @if (in_array($value->id, $rolePermissions) ) checked @endif value="{{$value->id}}" class="box1" ></td>
