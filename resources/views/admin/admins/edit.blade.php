...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">@lang('lang.admins')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> /
                @lang('lang.admins')</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="card-body">
        @if (session('status'))
            <div class="alert alert-success" role="alert">
                <button type="button" class="btn-close btn-close-white" data-dismiss="alert"
        ...
        <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
            ...
            <div class="col-md-5" id="fnWrapper">
                ...
                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                    name="name" type="text" placeholder="Name" value="{{ $admin->name }}">
            </div>
