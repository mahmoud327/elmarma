        ...
        <ul class="side-menu">
            ...
            @can('news-list')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('news.index') }}">news</a></li>
                    </ul>
                </li>
            @endcan
            ...
            @can('categories-list')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">categories</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
            ...
            @can('posts-list')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">posts</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
