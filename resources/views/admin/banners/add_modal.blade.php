    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo  mr-5" style="width:100%">
            <div class="modal-header">
                <h6 class="modal-title">@lang('lang.add banner')</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <form action="{{route('banners.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                          <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea  class="form-control" name="en[desc]"  value="{{old('desc')}}"  placeholder=@lang('lang.desc english')></textarea>
                                </div>
                                <div class="form-group">
                                    <textarea type="text" class="form-control" name="ar[desc]"  value="{{old('desc')}}"  placeholder=@lang('lang.desc arabic')></textarea>
                                </div>
